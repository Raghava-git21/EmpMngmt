...
function App() {
  ...
  async function senddetails() {
    ...
    let response = await axios.post('https://empmngmt.onrender.com/emp/add', empDetails);
    alert("Details sent successfully");
  }
  async function getAllUsers() {
    let response = await axios.get('https://empmngmt.onrender.com/emp/allUsers')

    setUser(response.data);
  }
  async function deleteUserBYId(id) {
    let response = await axios.delete(`https://empmngmt.onrender.com/emp/delete/${id}`)
    getAllUsers();
